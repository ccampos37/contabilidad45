...
Friend Class ClsMantMov1
	...
	Public Sub Limpia()
		...
		With frmantcomprobantes
			...
			VGValorCambio = RecuperaTipoCambio(VB6.Format(frmantcomprobantes.DTPFechaComprobCab._Value, "dd/mm/yyyy"), ModificarCampos.tipocambio.Venta)
			.lb_vcambio.Text = VB6.Format(VGValorCambio, "#.000 ")
			'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			.TxMonto.CtlText = VB6.Format(0, "#.00")
        ...
        With rs
            ...
            Select Case op
                Case 0
                    ...
                    While Not .EOF
                        'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
                        .Fields("detcomprobglosa").Value = frmantcomprobantes.TxGlosaComprobCab.CtlText
                        .Update()
                        .MoveNext()
                    End While
                    VGactulizodoc = False
                ...
                Case 6
                    'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
                    .Fields("detcomprobruc").Value = Trim(frmantcomprobantes.txRuc.CtlText)
                Case 7, 8
                    If VGRepiteDoc Then
                        VGactulizodoc = True
                        'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto POSANTERIOR. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                        ...
                        While Not .EOF
                            ...
                            'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
                            .Fields("detcomprobnumdocumento").Value = Left(frmantcomprobantes.TxSerie.CtlText, frmantcomprobantes.TxSerie.MaxLength) & frmantcomprobantes.TxNdoc.CtlText

                            .Fields("tipdocref").Value = frmantcomprobantes.CtrAyu_TipRef.xclave
                            'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
                            .Fields("detcomprobnumref").Value = frmantcomprobantes.TxNref.CtlText
                            'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto frmantcomprobantes.Dtp_FechaDocRef._Value. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                    ...
                    Else
                        ...
                        .Fields("documentocodigo").Value = frmantcomprobantes.CtrAyu_TipDoc.xclave
                        'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
                        .Fields("detcomprobnumdocumento").Value = Trim(frmantcomprobantes.TxSerie.CtlText) & Trim(frmantcomprobantes.TxNdoc.CtlText)
                    End If
                Case 9
                    'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto frmantcomprobantes.DtpFech_Ven._Value. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                ...
                Case 10
                    'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
                    .Fields("detcomprobglosa").Value = frmantcomprobantes.TxGlosa.CtlText
                Case 11 : .Fields("indicador").Value = Trim(vardllgen.ComboDato((frmantcomprobantes.CmbID.Text)))
                Case 12
                    ...
                    If (CDbl(.Fields("detcomprobitem").Value) = 1 Or flag) And vgcont <> 2 Then
                        ...
                        While Not .EOF
                            ...
                            Else
                                ...
                                'UPGRADE_WARNING: Se detectó el uso de Null/IsNull(). Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
                                'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto FechaAux. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
ActualizaMontos:
        With rs
            ...
            .Fields("tcambio").Value = Trim(vardllgen.ComboDato((frmantcomprobantes.CmbTcambio.Text)))
            'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto frmantcomprobantes.Dtp_FechaDoc._Value. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            .Fields("detcomprobfechaemision").Value = frmantcomprobantes.Dtp_FechaDoc._Value
            'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto ESNULO(). Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	Public Sub GrabarCabecera(ByVal op As Short, ByRef NumComprob As String, Optional ByVal Numlibro As String = "")
		...
		With VGCommandoSP
			...
			If op <= 2 Then
				...
				'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
				.Parameters("@cabcomprobobservaciones").Value = UCase(Trim(frmantcomprobantes.TxObsComprobCab.CtlText))
				'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
				.Parameters("@cabcomprobglosa").Value = UCase(Trim(frmantcomprobantes.TxGlosaComprobCab.CtlText))
				'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto ESNULO(). Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				...
				If frmantcomprobantes.VlNref Then
					'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
					.Parameters("@cabcomprobnref").Value = Trim(frmantcomprobantes.TxCtrNref.CtlText)
				Else
...
GrabaAuto: 
	...
	Public Sub MostrarCabecera(ByVal rs As ADODB.Fields)
		...
		With frmantcomprobantes
			...
			'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			.TxObsComprobCab.CtlText = rsaux("cabcomprobobservaciones").Value
			'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			.TxGlosaComprobCab.CtlText = rsaux("cabcomprobglosa").Value
			...
			'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto ESNULO(). Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			.TxCtrNref.CtlText = ESNULO((rsaux("cabcomprobnref").Value), "")
...
err_Renamed: 
	...
	Public Function ValidarGrabarCabecera(ByRef NR As Integer) As Boolean
		...
		With frmantcomprobantes
			...
			End If
			'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			If Trim(.TxGlosaComprobCab.CtlText) = "" Then
	...
	Public Function ValidarGrabarDetalle() As Boolean
		...
		With frmantcomprobantes
			...
			'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			'UPGRADE_NOTE: Enabled se actualizó a CtlEnabled. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			If (.TxSerie.CtlEnabled And .TxSerie.Visible) And Trim(.TxSerie.CtlText & .TxNdoc.CtlText) = "" Then
			...
			'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			'UPGRADE_NOTE: Enabled se actualizó a CtlEnabled. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
			If (.TxGlosa.CtlEnabled And .TxGlosa.Visible) And Trim(.TxGlosa.CtlText) = "" Then
	...
	End Function
	Public Function RecuperaTipoCambio(ByRef fecha As String, ByRef tipo As ModificarCampos.tipocambio) As Double
		Dim rsaux As ADODB.Recordset
		rsaux = New ADODB.Recordset
	...
	Public Function Verifidocumacancelar(Optional ByRef moneda As String = "", Optional ByRef fecha As Date = #12:00:00 AM#, Optional ByRef montototal As Double = 0, Optional ByRef montoacumamort As Double = 0) As Boolean
		...
		'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
		Ncomprob = Trim(frmantcomprobantes.TxSerie.CtlText) & IIf(Trim(frmantcomprobantes.TxSerie.CtlText) = "", "", "-") & Trim(frmantcomprobantes.TxNdoc.CtlText)
...
ERRX: 
	...
	Public Sub ActivaIngresorapido(ByVal rs1 As ADODB.Recordset, ByRef form1 As System.Windows.Forms.Form)
        With frmantcomprobantes
            'UPGRADE_ISSUE: Control Txtimpo no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
            .Txtimpo.Visible = False
            'UPGRADE_ISSUE: Control TxtIgv no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
            .TxtIgv.Visible = False
            'UPGRADE_ISSUE: Control TxtPerc no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
            .TxtPerc.Visible = False
            'UPGRADE_ISSUE: Control TxtInaf no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
            .TxtInaf.Visible = False
            If rs1.RecordCount = 0 Then
                'UPGRADE_ISSUE: Control FrameIngreso no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
            ...
            While Not rs1.EOF
                If rs1.Fields("detcomprobTipo").Value = "IMPO" Then
                    ...
                    If rs1.Fields("cuentacodigo").Value = "00" Then
                        'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto ESNULO(rs1!comodin, ). Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                        If ESNULO(rs1.Fields("comodin"), "") <> "" Then
                            'UPGRADE_ISSUE: Control CtrAyu_Cuenta1 no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                ...
                ElseIf rs1.Fields("detcomprobTipo").Value = "TOT" Then
                    If rs1.Fields("cuentacodigo").Value = "00" Then
                        'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto ESNULO(rs1!comodin, ). Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                        If ESNULO(rs1.Fields("comodin"), "") <> "" Then
                            'UPGRADE_ISSUE: Control CtrAyu_Cuenta2 no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
        ...
        With frmantcomprobantes
            ...
            While Not rs1.EOF
                If rs1.Fields("detcomprobTipo").Value = "IMPO" Then
                    ...
                    'UPGRADE_ISSUE: Control TxMonto no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                    'UPGRADE_ISSUE: Control Txtimpo no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                ...
                ElseIf rs1.Fields("detcomprobTipo").Value = "TOT" Then
                    'UPGRADE_ISSUE: Control TxtTot no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                    rs1.Fields("montosol").Value = Val(.TxtTot.Text)
                    'UPGRADE_ISSUE: Control TxMonto no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                    'UPGRADE_ISSUE: Control TxtTot no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                    .TxMonto.Text = Val(.TxtTot.Text)
                    'UPGRADE_ISSUE: Control CtrAyu_Analitico1 no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                    rs1.Fields("analiticocodigo").Value = .CtrAyu_Analitico1.xclave
                    'UPGRADE_ISSUE: Control CtrAyu_TipDoc1 no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                    rs1.Fields("documentocodigo").Value = .CtrAyu_TipDoc1.xclave
                    'UPGRADE_ISSUE: Control TxNdoc1 no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                    'UPGRADE_ISSUE: Control TxSerie1 no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
                    rs1.Fields("detcomprobnumdocumento").Value = .TxSerie1.Text + .TxNdoc1.Text
                    'UPGRADE_ISSUE: Control DTP_fecha1 no se pudo resolver porque está dentro del espacio de nombres genérico Form. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="084D22AD-ECB1-400F-B4C7-418ECEC5E36E"'
