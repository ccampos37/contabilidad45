...
ErrExiste: 
	...
	Public Function MostrarForm(ByRef pVentana As System.Windows.Forms.Form, ByRef pPos As String) As Object
	...
	Public Function MostrarFormVentas(ByRef pVentana As System.Windows.Forms.Form, ByRef pPos As String) As Object
	...
	Public Function Seguir(ByRef MBox As Object, ByRef ntecla As Short) As Object
		If ntecla = 13 Then
	...
	Public Function Limpiartexto(ByRef MBox As Object, ByRef ninicio As Short, ByRef nfin As Short, Optional ByRef Noincluir1 As Object = Nothing, Optional ByRef Noincluir2 As Short = 0) As Object
		Dim J As Short
		...
		For J = ninicio To nfin
			...
			Else
				'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto MBox(). Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				MBox(J) = Nothing
			End If
		Next J
	End Function
...
nerror: 
	...
	Public Function Escadena(ByRef pdato As Object) As String
		...
		If IsDbNull(pdato) Then
			Escadena = ""
			'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto pdato. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
Proceso: 
	...
	Public Function DatoMoneda(ByRef xValor As String) As String
		...
		End If
		rmone.Close()
		'UPGRADE_NOTE: El objeto rmone no se puede destruir hasta que no se realice la recolección de los elementos no utilizados. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		rmone = Nothing
	...
	Public Function VerificaDatoExistente(ByRef cn1 As ADODB.Connection, ByRef dato1 As String) As Object
		...
		If Rsql1.RecordCount > 0 Then
			'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto VerificaDatoExistente. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
...
errornum: 
	...
	Public Function Espunto(ByRef texto As Object) As Object
		'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto texto. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		If Trim(texto) = "." Or Trim(texto) = "-" Then
			'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto Espunto. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			Espunto = "0"
		Else
			'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto texto. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			'UPGRADE_WARNING: No se puede resolver la propiedad predeterminada del objeto Espunto. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
