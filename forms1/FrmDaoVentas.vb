...
Friend Class FrmDaoVentas
	...
	Private Sub cmdAceptar_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdAceptar.Click
		...
		VGCommandoSP.CommandText = "ct_DAOVentas_rpt"
	...
	Private Sub CmdImprimir_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdImprimir.Click
		...
		Call ImpresionRptProc("ct_DAOVentas.rpt", aform, aparam,  , " DAO")
	End Sub
	
	Private Sub FrmDaoVentas_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Dim RSparCompras As Object
		Me.Text = "DAO VENTAS - SUNAT HASTA EL MES DE : " & DesMes(VGParamSistem.Mesproceso)
		...
		SQL = "select * from ct_paramlibaux where paramlibauxtipo='VT'"
