...
Friend Class frmMantOperacion
    ...
    End Sub
    'Private Sub mTablaBasica1_ClickEvent(ByVal eventSender As System.Object, ByVal eventArgs As AxMantTablaBasica.__mTablaBasica_ClickEvent) Handles mTablaBasica1.ClickEvent
