...
Friend Class FrmLibroBalancedeComprobacion
    ...
    End Sub
    Private Sub OptForma0_CheckedChanged(sender As Object, e As EventArgs) Handles OptForma0.CheckedChanged
        lforma = 1
    End Sub

    Private Sub OptForma1_CheckedChanged(sender As Object, e As EventArgs) Handles OptForma1.CheckedChanged
        lforma = 2
    End Sub
End Class