Option Strict Off
Option Explicit On
Friend Class FrmRepBalanceComp
	...
	Private Sub FrmRepBalanceComp_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		Call CargaNivel()
		Call CargaRsFiltro()
