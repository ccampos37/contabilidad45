...
Friend Class frmMntCtaCteAnalitico
    ...
    Sub Edicion()
        ...
        If rs.RecordCount > 0 Then
            With rs
                ...
                Dtp_FechaDoc.Value = Format(.Fields("ctacteanaliticofechadoc").Value, "dd/mm/yyyy")
                DtpFech_Ven.Value = Format(.Fields("ctacteanaliticofechaven").Value, "dd/mm/yyyy")
                'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
    ...
    Sub GrabarCtacteAnalitico()
        ...
        With VGCommandoSP
            ...
            'UPGRADE_NOTE: Text se actualizó a CtlText. Haga clic aquí para obtener más información: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="A9E4979A-37FA-4718-9994-97DD76ED70A7"'
            .Parameters("@detcomprobnumdocumento").Value = Format(Trim(TxSerie.Text), "0000") & Format(Trim(TxNdoc.Text), "0000000000")
